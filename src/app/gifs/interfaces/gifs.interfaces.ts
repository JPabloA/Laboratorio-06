...
export class Convert {
  public static toGIF(json: string): Gif { // Esta
      return cast(JSON.parse(json), r("GIF"));
  }

  public static gIFToJson(value: Gif): string { // Esta
      return JSON.stringify(uncast(value, r("GIF")), null, 2);
  }
}
